 ...
 */
@Entity
@Table(name = "PjReservations")
public class PjReservations {
	@Id
	@GeneratedValue
	...
	public PjReservations(long id, String idAlfresco, String name, long idReservation, long fSize, Date dateFile) {
		super();
		this.id = id;
		this.idAlfresco = idAlfresco;
		this.name = name;
