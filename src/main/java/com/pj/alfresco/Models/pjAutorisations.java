 ...
 */
@Entity
@Table(name = "PjAutorisations")
public class pjAutorisations {
	@Id
	@GeneratedValue
	...
	public pjAutorisations() {
	}

	public pjAutorisations(long id, String idAlfresco, String name, long idAutorisation, long fSize, Date dateFile) {
		super();
		this.id = id;
		this.idAlfresco = idAlfresco;
		this.name = name;
